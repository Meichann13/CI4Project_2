    ...
    <table id="productTable" class="display">
        ...
        <thead>
            ...
            <tr>
                ...
                <th><input type="text" name="price" id="price" required></th>
            </tr><br>
            <tr>
                <th><label for="DESCRIPTION">Deskrpisi</label></th>
                <th><textarea name="DESCRIPTION" id="DESCRIPTION" required></textarea></th>
            </tr><br>
            <tr>
                <th><label for="category">Kategori</label></th>
                <th><input type="text" name="category" id="category" required></th>
            </tr><br>
            <tr>
                <th><button for="submit">Simpan</button></th>
            </tr>
        </th>
        </form>
        </table>
