...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="/profile2">Profile</a></li>
...
<form action="/products/store" method="post">
    <thead>
        <tr>
            ...
            <th><input type="text" name="name" id="name" value="<?= esc($product['name']); ?>" required></th>
        </tr><br>
        <tr>
            <th><label for="price">Harga</label></th>
            <th><input type="text" name="price" id="price" value="<?= esc($product['price']); ?>" required></th>
        </tr><br>
        <tr>
            <th><label for="DESCRIPTION">Deskripsi</label></th>
            <th><textarea name="DESCRIPTION" id="DESCRIPTION" required>=<?= esc($product['DESCRIPTION']); ?></textarea></th>
        </tr><br>
        <tr>
            <th><label for="category">Kategori</label></th>
            <th><input type="text" name="category" id="category" value="<?= esc($product['category']); ?>" required></th>
        </tr><br>
        <tr>
